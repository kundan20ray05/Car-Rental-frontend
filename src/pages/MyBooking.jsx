...
const MyBooking = () => {
  const { axios, user, currency, formatCurrency } = useAppContext();
  ...
  return (
    ...
    >
      <Title
        title="MyBookings"
        subTitle="View and manager your all car bookings "
        align="left"
      />

      <div>
        {bookings.length === 0 ? (
          <div className="mt-12 text-center py-8 border border-borderColor rounded-lg">
