...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      ...
      for booking, include pricing, availability, and car specification."/>
      ...
      text-sm mt-6 max-w-xl'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            <div className='flex flex-col w-full'>
              ...
              <input
                type="text"
                placeholder="e.g. BMW, Mrcedes, Audi..."
                required
                className='px-3 py-2 mt-1 border border-bordreColor rounded-md outline-none'
                value={car.brand}
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
            ...
            <div className='flex flex-col w-full'>
             ...
             {/* car Transmission, Fule Type, Seating Capacity */}
             <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
              <div className='flex flex-col w-full'>
              ...
              <select onChange={e=> setCar({...car, fule_type: e.target.value})} value={car.fule_type} className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'>
           ...
           <div className='flex flex-col w-full'>
            ...
            <button className='flex item-center gap-2 px-4 py-2.5 mt-4 bg-primary
